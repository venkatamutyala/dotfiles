...
| Path | Role |
|------|------|
| `index.html` | The installer. A `#!/bin/zsh` script despite the name; served at setup.venkatamutyala.com via GitHub Pages and run with `curl … \| zsh`. Line 1 is `#<plaintext>` so browsers render it as raw text. |
